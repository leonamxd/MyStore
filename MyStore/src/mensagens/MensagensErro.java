...
public class MensagensErro {
	...
	public void erroTipoCampo() {
		JOptionPane.showMessageDialog(null, "Tipo do campo inválido, verifique informações digitadas.", "Erro: CG_002",
				JOptionPane.ERROR_MESSAGE);
	}

	public void erroPreenchimentoCampos() {
		JOptionPane.showMessageDialog(null, "Campos obrigatórios não preenchidos.", "Erro: CG_003",
				JOptionPane.ERROR_MESSAGE);
	}
